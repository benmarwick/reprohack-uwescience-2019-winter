...
params: 
  title: "UW eScience Reprohack / organised by the Reproducible Research Special Interest Group"
  room_location: "UW eScience Institute"
  address: "WRF Data Science Studio, UW Physics/Astronomy Tower, 6th Floor, Campus Box 351570, 3910 15th Ave NE, Seattle, WA 98195 University of Washington, Seattle, WA"
  date: "DD MM 2019"
  time: "9.30am-15:30pm"
...
As all eScience events, we strive to make this event open and inclusive to all. As such the event is governed by the [eScience Code of Conduct](https://escience.washington.edu/code-of-conduct) and you should read it before participating. By participating, you are expected to uphold this code.
